...
static void SBCPUInstall(void)
{
    ...
    dispatch_after(
        ...
        ^{
             ...
             * 不再使用 app.keyWindow。
             *
             * keyWindow 在 iOS 13 以后已经废弃，
             * 当前 SDK 开启 -Werror 后会直接导致编译失败。
             */
